...
static std::vector<RPCResult> TransactionDescriptionString()
{
    return{{RPCResult::Type::NUM, "confirmations", "The number of confirmations for the transaction. Negative confirmations means the\n"
           ...
           {RPCResult::Type::STR, "qq_shadow_pow_expired_retired", /*optional=*/true, "Deprecated release-candidate marker. Its presence keeps the claim input reserved until wallet repair atomically reopens and quarantines the claim."},
           {RPCResult::Type::STR, "qq_shadow_pow_expired_retired_height", /*optional=*/true, "Deprecated historical retirement observation height; retained only for wallet-record compatibility until repair clears it."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_expired_retired_tip", /*optional=*/true, "Deprecated historical retirement observation block; retained only for wallet-record compatibility until repair clears it."},
