...
static std::vector<RPCResult> TransactionDescriptionString()
{
    return{{RPCResult::Type::NUM, "confirmations", "The number of confirmations for the transaction. Negative confirmations means the\n"
           ...
           {RPCResult::Type::STR, "qq_shadow_signal_source", /*optional=*/true, "Durable QQSIGNAL submission provenance: manual or automatic."},
           {RPCResult::Type::STR, "qq_shadow_signal_reorg_height", /*optional=*/true, "Former confirmation height retained when a QQSIGNAL is removed by a reorganization."},
           {RPCResult::Type::STR_HEX, "qq_shadow_signal_reorg_hash", /*optional=*/true, "Former confirmation block retained when a QQSIGNAL is removed by a reorganization."},
           {RPCResult::Type::STR, "qq_shadow_pow_authored", /*optional=*/true, "Set to \"1\" for a claim created by this wallet with complete creation provenance."},
           {RPCResult::Type::STR, "qq_shadow_pow_created_height", /*optional=*/true, "Claim target height recorded as durable wallet metadata."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_created_tip", /*optional=*/true, "Active-chain tip against which this wallet created the claim."},
           {RPCResult::Type::STR, "qq_shadow_pow_claim_relay_clock_schema", /*optional=*/true, "Relay-clock metadata schema. Version \"1\" means this claim's relay lifetime starts at a chain-derived logical birth instead of its host receive time."},
           {RPCResult::Type::STR, "qq_shadow_pow_claim_relay_birth", /*optional=*/true, "Canonical decimal logical relay-birth time for schema version 1, set to the greater of the durable schema high-water and the creation-tip median time past at guarded wallet commit."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_claim_relay_txid", /*optional=*/true, "Exact transaction id binding the relay-clock schema and birth to this wallet record; a copied or mismatched tuple is nonauthorizing."},
           {RPCResult::Type::STR, "qq_shadow_pow_lineage_schema", /*optional=*/true, "Same-anchor claim-lineage wallet-record schema version."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_lineage_family", /*optional=*/true, "Fingerprint of the confirmed fee-anchor generation shared by this claim family."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_lineage_root", /*optional=*/true, "Transaction id of the first wallet-authored claim in this same-anchor family."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_lineage_parent", /*optional=*/true, "Transaction id of the immediately preceding same-anchor sibling; absent on the root."},
           {RPCResult::Type::STR, "qq_shadow_pow_lineage_ordinal", /*optional=*/true, "Zero-based append-only position in the authenticated same-anchor claim family."},
           {RPCResult::Type::STR, "qq_shadow_pow_first_quarantine_height", /*optional=*/true, "First height at which this wallet persistently quarantined the claim."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_first_quarantine_tip", /*optional=*/true, "First active-chain tip at which this wallet persistently quarantined the claim."},
           {RPCResult::Type::STR, "qq_shadow_pow_branch_quarantine_height", /*optional=*/true, "Current-branch quarantine observation height used by bounded automatic recovery."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_branch_quarantine_tip", /*optional=*/true, "Current-branch tip authenticating the bounded automatic-recovery stale-depth observation."},
           {RPCResult::Type::STR, "qq_shadow_pow_adopted", /*optional=*/true, "Set to \"1\" after explicit atomic adoption of a reviewed historical claim component."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_adoption_tip", /*optional=*/true, "Exact active tip at which a historical claim component was adopted."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_adoption_fingerprint", /*optional=*/true, "Stable anchor-generation fingerprint authenticated by explicit component adoption."},
           {RPCResult::Type::STR, "qq_shadow_pow_quarantine", /*optional=*/true, "Set to \"1\" while a locally persisted Gold Rush PoW claim reserves its authenticated input pending authoritative mempool admission, or after the claim is removed. This does not assert peer visibility. Only the strict typed mining gate can authorize a current-policy sibling spending the same confirmed anchor."},
           ...
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_schema", /*optional=*/true, "Managed claim-resolution wallet-record schema version."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_resolution_anchor_txid", /*optional=*/true, "Confirmed wallet anchor transaction spent by a managed claim resolution."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_anchor_vout", /*optional=*/true, "Confirmed wallet anchor output spent by a managed claim resolution."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_resolution_fingerprint", /*optional=*/true, "Stable anchor-generation fingerprint bound to a managed claim resolution."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_origin", /*optional=*/true, "Whether a managed resolution was manually or automatically authorized."},
           ...
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_schema", /*optional=*/true, "Stored latest exact-plan authorization receipt schema; historical evidence, not current relay authority."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_plan", /*optional=*/true, "Stored plan identity of the latest explicit exact-plan authorization."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_tip", /*optional=*/true, "Stored active tip of the latest explicit exact-plan authorization."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_height", /*optional=*/true, "Stored active height of the latest explicit exact-plan authorization."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_generation", /*optional=*/true, "Stored wallet generation of the latest explicit exact-plan authorization."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_origin", /*optional=*/true, "Stored manual or automatic origin of the latest exact-plan authorization."},
           {RPCResult::Type::STR, "qq_shadow_pow_resolution_auth_wtxid", /*optional=*/true, "Stored witness transaction identity binding the authorization receipt to exact signed bytes."},
