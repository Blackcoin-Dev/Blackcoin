...
static std::vector<RPCResult> TransactionDescriptionString()
{
    return{{RPCResult::Type::NUM, "confirmations", "The number of confirmations for the transaction. Negative confirmations means the\n"
           ...
           {RPCResult::Type::STR, "qq_shadow_pow_expired_retired", /*optional=*/true, "Set to \"1\" after an exact wallet-authored QQP3/QQP4 claim is durably retired without creating, signing, broadcasting, or paying for a recovery transaction."},
