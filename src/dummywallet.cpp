...
void DummyWalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    argsman.AddHiddenArgs({
        ...
        "-autoresolvebatchfeecap=<amt>",
        "-autoresolverollingfeebudget=<amt>",
        "-autoresolverollingwindow=<n>",
        "-autoresolvemaxactions=<n>",
        "-autoresolvestaleblocks=<n>",
        ...
        "-qqshadowpowclaimcommitdelaymillis=<n>",
