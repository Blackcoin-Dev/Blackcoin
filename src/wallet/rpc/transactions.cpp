...
static std::vector<RPCResult> TransactionDescriptionString()
{
    return{{RPCResult::Type::NUM, "confirmations", "The number of confirmations for the transaction. Negative confirmations means the\n"
           ...
           {RPCResult::Type::STR, "qq_shadow_pow_expired_retired", /*optional=*/true, "Set to \"1\" for a narrow origin-expired legacy claim retired without a recovery transaction. Schema-lineage and exact locally authored origin-bound carriers are reclassified instead of retired."},
           {RPCResult::Type::STR, "qq_shadow_pow_expired_retired_height", /*optional=*/true, "Active-chain observation height authorizing zero-payment claim retirement."},
           {RPCResult::Type::STR_HEX, "qq_shadow_pow_expired_retired_tip", /*optional=*/true, "Active-chain block hash authenticating zero-payment claim retirement."},
