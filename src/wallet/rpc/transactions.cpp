...
static std::vector<RPCResult> TransactionDescriptionString()
{
    return{{RPCResult::Type::NUM, "confirmations", "The number of confirmations for the transaction. Negative confirmations means the\n"
           ...
           {RPCResult::Type::STR, "qq_shadow_pow_quarantine", /*optional=*/true, "Set to \"1\" when a peer-visible Gold Rush PoW claim remains reserved. Only the strict typed mining gate can authorize a current-policy sibling spending the same confirmed anchor."},
